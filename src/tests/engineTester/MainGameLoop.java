...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		RawModel pineModel = loader.loadToVAO(pineData.getVertices(), pineData.getTextureCoords(),
		...
		for (int i = 0; i < 500; i++) {
			...
			float z = random.nextFloat() * -1000;
			float y = terrain.getTerrainHeight(x, z);
			allPineTrees.add(new Entity(pineTextureModel, new Vector3f(x, y, z), 0, 0, 0f, 1f));
		}
		...
		ArrayList<RandomPlayer> randoms = new ArrayList<>();
		RandomPlayer rando = new RandomPlayer(playerModel, new Vector3f(200, 20, -250), 0, 0, 0, 5);
