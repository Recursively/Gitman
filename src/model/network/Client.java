...
public class Client extends Thread {
     ...
     *
     * @param socket         the socket to bind the streams to
     ...
     *
     * @param receivedPlayers the list of Player UID's
     */
     ...
     * @param packet   array of floats (x,y,z)
     */
     ...
     * @param entity     Entitiy to be updated
     */
