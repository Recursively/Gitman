...
public class Server extends Thread {
	 ...
	 * 
	 * @param serverUpdate
	 *            the update from the Server Player
	 * @param clientUpdate
	 *            the update from another Client Player
	 * @throws IOException
	 */
	 ...
	 * @throws IOException
	 *             failed to read from the inputStream
	 */
	 ...
	 * @throws IOException
	 *             failed to write to the outputStream
	 */
